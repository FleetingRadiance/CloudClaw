export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "CloudClow에 오신 것을 환영합니다",
        desc: "몇 단계만으로 지식 베이스, 대화, 에이전트의 핵심 사용법을 안내합니다. '다음'을 눌러 시작하세요.",
      },
      knowledge: {
        title: "지식 베이스 만들기",
        desc: "모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 CloudClow가 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.",
      },
      chat: {
        title: "AI 대화 시작하기",
  ...
  settings: {
    ...
    cloudclowCloud: {
      ...
      description: 'CloudClow Cloud APPID 및 APPSECRET 자격 증명을 설정합니다. 자격 증명은 모델 서비스와 문서 파싱 엔진에 사용됩니다.',
      viewDocs: '문서 보기',
      unconfigured: '자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 입력하세요.',
      configured: '자격 증명이 설정되었으며 정상 작동 중입니다.',
      expired: 'CloudClow Cloud 자격 증명 만료',
      expiredDefault: '서비스 재시작 후 암호화 키가 변경되어 저장된 자격 증명을 복호화할 수 없습니다. 다시 입력하세요.',
      reconfigure: '재설정',
      appIdLabel: 'APPID',
      appIdDesc: 'CloudClow Cloud 애플리케이션 ID',
      appIdPlaceholder: 'APPID 입력',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'CloudClow Cloud 애플리케이션 비밀키',
      appSecretPlaceholder: 'APPSECRET 입력',
      saveHint: '저장 전 서비스 연결 가능 여부를 확인하고 암호화하여 저장합니다.',
      saveBtn: '자격 증명 저장',
      usageTitle: '사용 가이드',
      usageSteps: '1. 이 페이지에서 APPID와 APPSECRET을 입력하고 저장\n2. 모델 서비스: 모델 관리에서 Remote API 소스로 모델 추가, 공급자로 CloudClowCloud 선택\n3. 문서 파싱: 지식 베이스 설정 → 파싱 엔진에서 해당 파일 유형에 CloudClow Cloud 엔진 선택',
      fillRequired: 'APPID와 APPSECRET을 입력하세요',
      saveSuccess: '자격 증명 저장 완료',
      saveFailed: '자격 증명 저장 실패',
      credentialConfigured: 'CloudClowCloud 자격 증명이 설정되었습니다.',
      credentialExpired: '자격 증명이 만료되었습니다. 재설정하세요.',
      credentialUnconfigured: 'CloudClowCloud 자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 먼저 설정하세요.',
      checkingStatus: '자격 증명 상태 확인 중...',
      goToSettings: '설정으로 이동',
      modelHintConfigured: 'CloudClowCloud 자격 증명이 설정되었습니다. 지원 모델은',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: cloudclow/images',
      prefixPlaceholder: '예: cloudclow',
  ...
  initialization: {
    title: "초기화",
    welcome: "CloudClow에 오신 것을 환영합니다",
  ...
  system: {
    ...
    retry: "재시도",
    versionLabel: "앱 버전",
    versionDescription: "애플리케이션 서비스(cloudclow-app)의 버전 번호",
    frontendVersionLabel: "UI 버전",
    frontendVersionDescription: "UI(cloudclow-ui) 빌드 버전 번호",
  ...
  createChat: {
    title: "안녕하세요, CloudClow입니다 — 당신의 지식을 손끝에",
    ...
    parser: {
      ...
      engines: {
        ...
        cloudclowcloud: {
          ...
          desc: 'CloudClow Cloud를 통한 문서 파싱',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  ldapUserManagement: {
    title: "LDAP 사용자 관리",
    description: "LDAP 인증 사용자를 모두 보고 관리합니다. 사용자를 삭제하면 관련 테넌트, 지식 베이스 및 조직 멤버십도 함께 제거됩니다.",
    columns: {
      username: "사용자",
      status: "상태",
      createdAt: "생성 시간",
    },
    confirmDelete: "이 LDAP 사용자를 삭제하시겠습니까? 이 작업은 사용자 및 모든 관련 데이터(테넌트, 지식 베이스, 조직 멤버십)를 삭제하며 복구할 수 없습니다.",
    deleteSuccess: "LDAP 사용자가 삭제되었습니다",
    deleteFailed: "삭제에 실패했습니다",
    fetchFailed: "LDAP 사용자 목록을 불러오지 못했습니다",
  },
  tenantMember: {
    title: "멤버 관리",
