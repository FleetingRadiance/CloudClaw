export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в CloudClow',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и CloudClow автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  settings: {
    ...
    cloudclowCloud: {
      ...
      description: 'Настройте учётные данные APPID и APPSECRET для CloudClow Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные CloudClow Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения CloudClow Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения CloudClow Cloud',
      ...
      usageSteps: '1. Заполните и сохраните APPID и APPSECRET\n2. Модели: перейдите в управление моделями, добавьте модель с источником Remote API, выберите CloudClowCloud\n3. Парсинг документов: перейдите в настройки базы знаний → движок парсинга, выберите CloudClow Cloud для нужных типов файлов',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные CloudClowCloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные CloudClowCloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные CloudClowCloud настроены. Поддерживаемые модели см. в',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. cloudclow/images',
      prefixPlaceholder: 'напр. cloudclow',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в CloudClow',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (cloudclow-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (cloudclow-ui)',
  ...
  createChat: {
    title: 'Привет, я CloudClow — ваши знания всегда под рукой',
  ...
  chat: {
    ...
    documentGeneratedHint: 'Документ создан. Просмотр и скачивание доступны в ответе ниже.',
    previewUnsupportedInline: 'Этот тип файла не поддерживает встроенный просмотр.',
    previewInFullscreen: 'Просмотр в полноэкранном режиме',
    documentGenerated: 'Документ создан',
    previewUnsupported: 'Просмотр этого типа файлов не поддерживается',
    previewLoadFailed: 'Не удалось загрузить документ',
    ...
    parser: {
      ...
      engines: {
        ...
        cloudclowcloud: {
          ...
          desc: 'Парсинг документов через CloudClow Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  ldapUserManagement: {
    ...
    description: 'Просмотр и управление всеми пользователями с LDAP-аутентификацией. Удаление пользователя также удалит связанный тенант, базы знаний и членство в организациях.',
    columns: {
      username: 'Пользователь',
      status: 'Статус',
      createdAt: 'Дата создания',
    },
    confirmDelete: 'Вы уверены, что хотите удалить этого LDAP-пользователя? Это удалит пользователя и все связанные данные (тенант, базы знаний, членство в организациях) без возможности восстановления.',
    deleteSuccess: 'LDAP-пользователь удалён',
    deleteFailed: 'Не удалось удалить',
    fetchFailed: 'Не удалось загрузить список LDAP-пользователей',
  },
  tenantMember: {
    title: 'Участники',
