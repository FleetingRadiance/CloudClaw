export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，商业西北智能体 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  chat: {
    ...
    rawOutputLabel: "原始输出",
    documentGeneratedHint: "文档已生成，请在下方正文查看预览与下载",
    previewUnsupportedInline: "此文件类型暂不支持内联预览",
    previewInFullscreen: "全屏预览",
    documentGenerated: "文档已生成",
    previewUnsupported: "暂不支持预览此文件类型",
    previewLoadFailed: "加载文档失败",
  ...
  settings: {
    ...
    roleDenied: {
      ...
      title: "商业西北智能体 Cloud",
      description: "配置 商业西北智能体 Cloud 的 APPID 和 APPSECRET 凭证。凭证用于模型服务和文档解析引擎。",
      viewDocs: "查看文档",
      unconfigured: "尚未配置凭证，请填写 APPID 和 APPSECRET",
      configured: "凭证已配置，状态正常",
      expired: "商业西北智能体 Cloud 凭证已失效",
      expiredDefault: "服务重启后加密密钥已变更，已保存的凭证无法解密。请重新填写凭证。",
      reconfigure: "重新配置",
      appIdLabel: "APPID",
      appIdDesc: "商业西北智能体 Cloud 的应用 ID",
      appIdPlaceholder: "请输入 APPID",
      appSecretLabel: "APPSECRET",
      appSecretDesc: "CloudClow Cloud 的应用密钥",
      appSecretPlaceholder: "请输入 APPSECRET",
      saveHint: "保存后将验证服务可达性并加密存储凭证",
      saveBtn: "保存凭证",
      usageTitle: "使用说明",
      usageSteps: "1. 在此页面填写并保存 APPID 和 APPSECRET\n2. 模型服务：前往「模型管理」添加模型，选择 Remote API 来源，厂商选择「CloudClowCloud」\n3. 文档解析：前往「知识库设置 → 解析引擎」，为对应文件类型选择「CloudClow Cloud」引擎",
      fillRequired: "请填写 APPID 和 APPSECRET",
      saveSuccess: "凭证保存成功",
      saveFailed: "凭证保存失败",
      credentialConfigured: "CloudClowCloud 凭证已配置",
      credentialExpired: "凭证已失效，请重新配置。",
      credentialUnconfigured: "尚未配置 CloudClowCloud 凭证，请先填写 APPID 和 APPSECRET。",
      checkingStatus: "正在检查凭证状态...",
      goToSettings: "前往设置中配置",
      modelHintConfigured: "CloudClowCloud 凭证已配置。支持的模型可参考",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 cloudclow/images",
      prefixPlaceholder: "如 cloudclow",
  ...
  auth: {
    ...
    ldapLogin: "LDAP登录",
    ldapLoginTitle: "LDAP域账户登录",
    ldapLoginName: "域账户名",
    ldapLoginNamePlaceholder: "输入域账户名",
    ldapLoginNameRequired: "请输入域账户名",
    ldapLoginSuccess: "LDAP登录成功！",
    ldapLoginFailed: "LDAP登录失败",
    ldapLoginHint: "请使用您的域账户登录",
    ldapDomainLogin: "LDAP域登录",
    switchToLdap: "LDAP域登录",
    switchToEmail: "管理员登录",
    register: "注册",
    registering: "注册中...",
    createAccount: "创建账户",
    ...
    firstTime: "首次使用 商业西北智能体？",
    registerSuccess: "注册成功！系统已为您创建专属空间，请登录",
    registerFailed: "注册失败",
    subtitle: "商业西北智能体 - 智能数据分析与AI知识管理平台",
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxUnavailableHint: "沙箱尚未就绪，Skills 配置仍会保存，运行时将按需启动沙箱。", 
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（cloudclow-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（cloudclow-ui）的构建版本号",
  ...
  platform: {
    name: "Mixc Claw",
    subtitle: "华润万象生活-西北大区智能体平台",
    description: "业务咨询、智能问数、知识库管理、Skills管理，助力办公与决策",
    rag: "思维链 CoT",
    agent: "AI 智能体",
    wiki: "Wiki 知识库",
    hybridSearch: "Skills 编排",
    localDeploy: "本地部署",
  ...
  scheduledTask: {
    title: "定时任务",
    subtitle: "配置智能体定时执行，让 AI 按计划自动工作",
    createTask: "创建定时任务",
    editTask: "编辑定时任务",
    emptyTip: "暂无定时任务，创建一个让 AI 按计划自动工作",
    fetchError: "获取定时任务列表失败",
    deleteSuccess: "任务已删除",
    deleteError: "删除任务失败",
    toggleError: "切换任务状态失败",
    ...
    selectAgent: "选择智能体",
    selectAgentPlaceholder: "选择要执行的智能体",
    agentRequired: "请选择智能体",
    prompt: "提示词",
    promptPlaceholder: "请输入提示词，描述任务要做什么",
    ...
    typeOnce: "一次性",
    cronExpr: "Cron 表达式",
    cronHint: "如 0 9 * * 1-5（工作日9点）",
    intervalMinutes: "间隔分钟数",
    intervalHint: "每隔 N 分钟执行一次",
    scheduleTime: "执行时间",
    dayOfWeek: "星期几",
    dayOfMonth: "几号",
    runOnceAt: "执行时间",
    ...
    webSearchEnabledHint: "启用后定时任务执行时将进行联网搜索",
    selectedSkills: "选择技能",
    selectedSkillsPlaceholder: "选择要使用的技能",
    selectedSkillsHint: "仅 ReAct 智能体支持技能选择",
    ...
    execStatusRate_limit: "限流",
    // 执行结果页
    backToList: "返回列表",
    selectExecution: "选择左侧执行记录查看详情",
    noResult: "本次执行无结果内容",
    duration: "耗时",
    processSteps: "执行过程",
    stepThought: "思考",
    ...
    agentPreparing: "正在准备执行...",
    waitingForExecution: "等待执行开始...",
    taskPromptLabel: "任务提示",
  },
  skill: {
    title: "技能管理",
    subtitle: "管理您的自定义技能，上传和配置技能文件",
    uploadSkill: "上传技能",
    emptyText: "暂无技能",
    uploadFirst: "上传第一个技能",
    sourceUser: "自定义",
    ...
    deleteConfirmMsg: "确定要删除技能「{name}」吗？此操作不可撤销。",
    noFilesSelected: "请选择要上传的文件",
    viewContent: "查看内容",
    contentTitle: "技能内容",
    noContent: "暂无内容",
    loadContentFailed: "加载技能内容失败",
    skillMdRequired: "必须包含 SKILL.md 文件",
    zipFileRequired: "请上传 .zip 格式的压缩包",
    fileTooLarge: "文件大小超过 {size}MB 限制",
    tooManyFiles: "最多上传 {count} 个文件",
    selectedFiles: "已选文件",
    uploadZoneTitle: "点击或拖拽上传技能包",
    uploadZoneOr: "或",
    uploadZoneBrowse: "浏览本地文件",
    uploadZoneHint: "仅支持 .zip 格式，最大 20 MB",
    confirmUpload: "确认上传",
    tabMine: "我的技能",
    tabAll: "全部技能",
    filterByLdap: "按 LDAP 账户筛选",
    searchByName: "搜索技能名称或描述...",
    formatHint: {
      title: "技能格式要求",
      zipRequired: "请上传 .zip 压缩包，压缩包根目录必须包含 SKILL.md",
      required: "必须包含 SKILL.md 文件（定义技能名称、描述和说明）",
      optional: "可选目录：scripts/（脚本文件）、references/（参考文档）、requirements.txt",
      namePattern: "技能名称：小写字母、数字和连字符，如 my-skill-name（上传后自动添加用户前缀）",
      maxSize: "压缩包不超过 {size}MB",
      viewExample: "查看格式示例",
      downloadDemo: "下载示例技能包（demo-skill.zip）",
    },
    share: "分配",
    shareTitle: "分配技能到共享空间",
    sharedSpaces: "已分配的共享空间",
    sharedReadOnly: "只读",
    noShares: "该技能尚未分配到任何共享空间",
    unshare: "取消分配",
    unshareSuccess: "取消分配成功",
    unshareFailed: "取消分配失败",
    loadSharesFailed: "加载分配信息失败",
    enterTenantId: "输入共享空间ID",
    searchSharedSpace: "搜索共享空间（名称）",
    tenantSearchFailed: "搜索共享空间失败，请稍后重试",
    shareToSpace: "分配到共享空间",
    shareToTenant: "分配到共享空间",
    shareSuccess: "分配成功",
    shareFailed: "分配失败",
  },
  organization: {
    ...
    transferMember: "变更空间",
    transferMemberDesc: "将成员「{name}」变更至其他空间，变更后该成员将属于新空间",
    transferTargetOrg: "目标空间",
    transferTargetOrgPlaceholder: "请选择目标空间",
    transferNoOtherOrg: "暂无可变更的空间，请先创建其他空间",
    memberTransferred: "成员已变更至新空间",
    memberTransferFailed: "变更空间失败",
    empty: "您还没有加入任何共享空间",
    ...
    parser: {
      ...
      engines: {
        ...
        cloudclowcloud: {
          ...
          desc: "使用 CloudClow Cloud 进行文档解析",
        },
        markitdown: {
          name: "MarkItDown",
  ...
  ldapUserManagement: {
    title: "LDAP 用户管理",
    description: "查看和管理所有 LDAP 认证用户。删除用户将同时清除其关联的租户、知识库及组织成员关系。",
    columns: {
      username: "用户",
      ldapLoginName: "LDAP 登录名",
      status: "状态",
      createdAt: "创建时间",
    },
    searchPlaceholder: "搜索用户名、邮箱或LDAP登录名",
    confirmDelete: "确定删除该 LDAP 用户吗？此操作将删除该用户及其所有关联数据（租户、知识库、组织成员关系），不可恢复。",
    deleteSuccess: "LDAP 用户已删除",
    deleteFailed: "删除失败",
    fetchFailed: "加载 LDAP 用户列表失败",
  },
  tenantMember: {
    title: "成员管理",
