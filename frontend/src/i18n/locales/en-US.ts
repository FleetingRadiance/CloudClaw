export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and 商业西北智能体 parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxUnavailableHint: 'Sandbox is not ready yet; your Skills selection will still be saved and the sandbox will start on demand at runtime.',
  ...
  settings: {
    ...
    cloudclowCloud: {
      title: 'CloudClow Cloud',
      description: 'Configure CloudClow Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'CloudClow Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'CloudClow Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'CloudClow Cloud application secret',
      ...
      usageSteps: '1. Fill in and save APPID and APPSECRET on this page\n2. Model services: Go to Model Management, add a model with Remote API source, select CloudClowCloud as provider\n3. Document parsing: Go to Knowledge Base Settings → Parser Engine, select CloudClow Cloud engine for desired file types',
      ...
      credentialConfigured: 'CloudClowCloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'CloudClowCloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'CloudClowCloud credentials configured. See supported models in',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. cloudclow/images',
      prefixPlaceholder: 'e.g. cloudclow',
  ...
  auth: {
    ...
    ldapLoginTitle: 'LDAP Domain Login',
    ldapLoginName: 'Domain Account',
    ldapLoginNamePlaceholder: 'Enter domain account name',
    ldapLoginNameRequired: 'Domain account is required',
    ldapLoginSuccess: 'LDAP login successful!',
    ldapLoginFailed: 'LDAP login failed',
    ldapLoginHint: 'Please use your domain account to login',
    ldapDomainLogin: 'LDAP Domain Login',
    switchToLdap: 'LDAP Domain Login',
    switchToEmail: 'Admin Login',
    username: 'Username',
    email: 'Email',
    password: 'Password',
    confirmPassword: 'Confirm Password',
  ...
  createChat: {
    title: 'Hi, I am 商业西北智能体 — your knowledge, within reach',
...
\
  ...
  chat: {
    ...
    documentGeneratedHint: 'Document generated. See preview and download in the answer below.',
    previewUnsupportedInline: 'This file type does not support inline preview.',
    previewInFullscreen: 'Full-screen preview',
    documentGenerated: 'Document generated',
    previewUnsupported: 'Preview not supported for this file type',
    previewLoadFailed: 'Failed to load document',
    ...
    selectedSkillRemove: 'Remove skill',
  },
  tenant: {
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (cloudclow-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (cloudclow-ui)',
  ...
  platform: {
    name: 'Business Northwest AI Agent',
    subtitle: 'Business Northwest AI Agent',
    ...
    rag: 'Chain of Thought (CoT)',
    agent: 'AI Agent',
    wiki: 'Wiki Knowledge Base',
    hybridSearch: 'Skills Orchestration',
  ...
  scheduledTask: {
    ...
    subtitle: 'Configure agents to run on schedule, let AI work automatically',
    createTask: 'Create Task',
    editTask: 'Edit Task',
    emptyTip: 'No scheduled tasks yet. Create one to let AI work on a schedule',
    fetchError: 'Failed to fetch tasks',
    deleteSuccess: 'Task deleted',
    deleteError: 'Failed to delete task',
    toggleError: 'Failed to toggle task',
    triggerSuccess: 'Task triggered',
    triggerError: 'Failed to trigger task',
    ...
    selectAgent: 'Select agent',
    selectAgentPlaceholder: 'Choose an agent to execute',
    agentRequired: 'Agent is required',
    prompt: 'Prompt',
    promptPlaceholder: 'Enter a prompt describing what the task should do',
    ...
    cronHint: 'e.g. 0 9 * * 1-5 (weekdays 9AM)',
    intervalMinutes: 'Interval (min)',
    intervalHint: 'Run every N minutes',
    scheduleTime: 'Time',
    ...
    webSearchEnabledHint: 'When enabled, scheduled tasks will perform web searches during execution',
    selectedSkills: 'Select skills',
    selectedSkillsPlaceholder: 'Select skills to use',
    selectedSkillsHint: 'Only ReAct agents support skill selection',
    ...
    saturday: 'Sat',
    sunday: 'Sun',
    execLogTitle: 'Execution logs - {name}',
    noExecLogs: 'No execution records',
    execStatusPending: 'Pending',
    execStatusRunning: 'Running',
    execStatusSuccess: 'Success',
    execStatusFailed: 'Failed',
    execStatusTimeout: 'Timeout',
    execStatusRate_limit: 'Rate limited',
    backToList: 'Back to list',
    selectExecution: 'Select an execution from the left to view details',
    noResult: 'No result content for this execution',
    duration: 'Duration',
    ...
    agentPreparing: 'Preparing execution...',
    waitingForExecution: 'Waiting for execution to start...',
    taskPromptLabel: 'Task prompt',
  },
  skill: {
    title: 'Skills',
    subtitle: 'Manage your custom skills, upload and configure skill files',
    uploadSkill: 'Upload Skill',
    emptyText: 'No skills yet',
    uploadFirst: 'Upload your first skill',
    sourceUser: 'Custom',
    sourcePreloaded: 'Preloaded',
    noDescription: 'No description',
    ...
    contentTitle: 'Skill Content',
    noContent: 'No content available',
    loadContentFailed: 'Failed to load skill content',
    skillMdRequired: 'SKILL.md file is required',
    fileTooLarge: 'File size exceeds {size}MB limit',
    tooManyFiles: 'Maximum {count} files allowed',
    selectedFiles: 'Selected files',
    uploadZoneTitle: 'Click or drag skill package here',
    uploadZoneOr: 'or',
    uploadZoneBrowse: 'Browse files',
    uploadZoneHint: 'Only .zip, up to 20 MB',
    confirmUpload: 'Upload',
    tabMine: 'My Skills',
    tabAll: 'All Skills',
    filterByLdap: 'Filter by LDAP account',
    searchByName: 'Search skill name or description...',
    formatHint: {
      title: 'Skill Format Requirements',
      required: 'Must include a SKILL.md file (defines skill name, description and instructions)',
      optional: 'Optional files: scripts/*.py, scripts/*.sh, references/*.md, requirements.txt',
      namePattern: 'Skill name: lowercase letters, numbers and hyphens, e.g. my-skill-name (user prefix added automatically)',
      maxFiles: 'Maximum {count} files per upload',
      maxSize: 'Each file must not exceed {size}MB',
      viewExample: 'View format example',
      downloadDemo: 'Download demo skill package (demo-skill.zip)',
    },
    share: 'Share',
    shareTitle: 'Share Skill to Workspaces',
    sharedSpaces: 'Shared Workspaces',
    sharedReadOnly: 'Read-only',
    noShares: 'This skill has not been shared to any workspace yet',
    unshare: 'Unshare',
    unshareSuccess: 'Unshared successfully',
    unshareFailed: 'Failed to unshare',
    loadSharesFailed: 'Failed to load share information',
    enterTenantId: 'Enter Workspace ID',
    searchSharedSpace: 'Search workspaces (name)',
    tenantSearchFailed: 'Failed to search workspaces; please try again later',
    shareToSpace: 'Share to Workspace',
    shareToTenant: 'Share to Workspace',
  ...
  organization: {
    ...
    transferMember: 'Transfer Space',
    transferMemberDesc: 'Transfer member "{name}" to another space. The member will belong to the new space after transfer.',
    transferTargetOrg: 'Target Space',
    transferTargetOrgPlaceholder: 'Select target space',
    transferNoOtherOrg: 'No other spaces available. Please create another space first.',
    memberTransferred: 'Member transferred to new space',
    memberTransferFailed: 'Failed to transfer member',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        cloudclowcloud: {
          name: 'CloudClow Cloud',
          desc: 'Document parsing via CloudClow Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  ldapUserManagement: {
    title: 'LDAP Users',
    description: 'View and manage all LDAP-authenticated users. Deleting a user will also remove their associated tenant, knowledge bases, and organization memberships.',
    columns: {
      username: 'User',
      ldapLoginName: 'LDAP Login',
      status: 'Status',
      createdAt: 'Created At',
    },
    searchPlaceholder: 'Search by username, email, or LDAP login name',
    confirmDelete: 'Are you sure you want to delete this LDAP user? This will delete the user and all associated data (tenant, knowledge bases, organization memberships) and cannot be undone.',
    deleteSuccess: 'LDAP user deleted',
    deleteFailed: 'Failed to delete',
    fetchFailed: 'Failed to load LDAP user list',
  },
  tenantMember: {
    title: 'Members',
