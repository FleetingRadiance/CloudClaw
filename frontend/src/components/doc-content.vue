...
const TRACE_DRAWER_WIDTH_KEY = 'cloudclow-trace-drawer-width';
...
// ============== 主抽屉（文档详情）宽度可调 ==============
const MAIN_DRAWER_WIDTH_KEY = 'cloudclow-doc-drawer-width';
        ...
        >
           ...
           opens the secondary drawer. -->
            ...
            <div ref="docMarkdownRoot" class="doc-markdown-root">
                ...
                <div
                    v-else-if="details.summary_status === 'pending' || details.summary_status === 'processing'"
                    class="summary_box"
                >
                    <span class="label">{{ $t('knowledgeBase.documentSummary') }}</span>
                            ...
                            <div v-if="chunk.hasParent" class="parent-context-section">
                                <div class="parent-context-toggle" @click="toggleParentContext(chunk.original, index)">
                                    <t-icon
                                        ...
                                        :name="isParentExpanded(index) ? 'chevron-down' : 'chevron-right'"
                                        size="14px"
                                    />
