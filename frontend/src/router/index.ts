...
const LITE_LAST_PATH_KEY = 'cloudclow_lite_last_path'
const AUTO_SETUP_FAILED_KEY = 'cloudclow_auto_setup_failed'
...
function isLiteEdition(authStore: ReturnType<typeof useAuthStore>) {
  return authStore.isLiteMode || localStorage.getItem('cloudclow_lite_mode') === 'true'
}
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/ldap-login",
      name: "ldapLogin",
      component: () => import("../views/auth/LdapLogin.vue"),
      meta: { requiresAuth: false, requiresInit: false }
    },
    {
      path: "/register",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "skills/upload",
          name: "skillUpload",
          component: () => import("../views/skill/SkillUpload.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
        {
        ...
        },
        {
          ...
          component: () => import("../views/scheduled-task/TaskEditorPage.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
        {
        ...
        },
        {
          ...
          component: () => import("../views/scheduled-task/TaskExecutionView.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
...
router.beforeEach(async (to, from, next) => {
  ...
  // LDAP normal users can access knowledge-bases, agents, chat pages
