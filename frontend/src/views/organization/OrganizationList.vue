              ...
              <div ref="inviteBodyInnerRef" class="invite-body-inner">
                ...
                <div v-if="!invitePreviewLoading && !invitePreviewData"
                  ...
                  <div class="join-modal-tabs">
                    ...
                    <div v-if="!isLdapUser" :class="['join-tab', { active: joinStep === 'search' }]" @click="handleSearchTabClick">
...
// Check if current user is an LDAP normal user
...
const canManageOrg = computed(
  () => !isLdapUser.value && (authStore.hasRole('admin') || authStore.canAccessAllTenants)
)
const noPermissionTip = computed(() => isLdapUser.value ? t('organization.rbac.needTenantAdminTip') : t('organization.rbac.needTenantAdminTip'))
