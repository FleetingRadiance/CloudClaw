<template>
    <Teleport to="body">
                            ...
                            <div class="settings-nav">
                                ...
                                >
                                    ...
                                    <span
                                        v-if="
                                            item.badge != null &&
                                            (item.key === 'sharedKb' || item.key === 'sharedAgents'
                                                ? true
                                                : item.badge > 0)
                                        "
                                        :class="[
                            ...
                            <div class="content-wrapper">
                                                    ...
                                                    >
                                                        <div class="avatar-trigger-wrap">
                                                            <SpaceAvatar
                                                                ...
                                                                size="medium"
                                                            />
                                                            <span v-if="isAdmin" class="avatar-change-hint">{{
                                                                $t('organization.avatar')
                                                            }}</span>
                                                        </div>
                                                        <template #content>
                                                            <div class="avatar-popover-content" @click.stop>
                                                                <p class="avatar-popover-title">
                                            ...
                                            <div class="setting-control full-width">
                                                <div class="invite-card">
                                                    ...
                                                    <div class="invite-method">
                                                        ...
                                                        <div class="invite-code-box">
                                                            ...
                                                            <div class="invite-code-actions">
                                                                ...
                                                                <t-tooltip
                                                                    :content="$t('organization.refreshInviteCode')"
                                                                >
                                                                    <t-button
                                                                        variant="text"
                                                                        size="small"
                                                        ...
                                                        <p v-if="inviteCode" class="invite-remaining">
                                                    ...
                                                    <div class="invite-method">
                                                        ...
                                                        <p class="invite-validity-desc">
                                                            {{ $t('organization.settings.inviteLinkValidityDesc') }}
                                                        </p>
                                                        <t-select
                                                    ...
                                                    <div class="invite-method">
                                                        <div class="invite-method-header">
                                                            ...
                                                            <span class="invite-method-title">{{
                                                                $t('organization.settings.inviteLink')
                                                            }}</span>
                                                        </div>
                                                    ...
                                                    <div class="invite-method">
                                                        <div class="invite-method-header">
                                                            ...
                                                            <span class="invite-method-title">{{
                                                                $t('organization.settings.requireApproval')
                                                            }}</span>
                                                        </div>
                                                    ...
                                                    <div class="invite-method">
                                                        <div class="invite-method-header">
                                                            ...
                                                            <span class="invite-method-title">{{
                                                                $t('organization.settings.searchable')
                                                            }}</span>
                                                        </div>
                                                        <div class="approval-toggle">
                                                            <t-switch
                                                    ...
                                                    <div class="invite-method">
                                                        <div class="invite-method-header">
                                                            ...
                                                            <span class="invite-method-title">{{
                                                                $t('organization.settings.memberLimit')
                                                            }}</span>
                                                        </div>
                                                        <p class="invite-validity-desc">
                                                            {{ $t('organization.settings.memberLimitDesc') }}
                                                        </p>
                                                        <div class="member-limit-input-row">
                                                            <t-input-number
                                                                ...
                                                                :max="10000"
                                                                :placeholder="
                                                                    $t('organization.settings.memberLimitPlaceholder')
                                                                "
                                                                theme="normal"
                                                                style="width: 140px"
                                                            />
                                        ...
                                        <div class="permissions-compact-grid">
                                            <div
                                                :class="[
                                                    'perm-role-block',
                                                    'admin',
                                                    { 'is-me': orgInfo?.my_role === 'admin' }
                                                ]"
                                            >
                                                <div class="perm-role-tag">
                                                    <t-icon name="user-safety" size="12px" />
                                                    <span>{{ $t('organization.role.admin') }}</span>
                                                    <span v-if="orgInfo?.my_role === 'admin'" class="me-badge">{{
                                                        $t('common.me')
                                                    }}</span>
                                                </div>
                                                <div class="perm-items">
                                                    <span class="perm-item has"
                                            ...
                                            <div
                                                :class="[
                                                    'perm-role-block',
                                                    'editor',
                                                    { 'is-me': orgInfo?.my_role === 'editor' }
                                                ]"
                                            >
                                                <div class="perm-role-tag">
                                                    <t-icon name="edit" size="12px" />
                                                    <span>{{ $t('organization.role.editor') }}</span>
                                                    <span v-if="orgInfo?.my_role === 'editor'" class="me-badge">{{
                                                        $t('common.me')
                                                    }}</span>
                                                </div>
                                                <div class="perm-items">
                                            ...
                                            <div
                                                :class="[
                                                    'perm-role-block',
                                                    'viewer',
                                                    { 'is-me': orgInfo?.my_role === 'viewer' }
                                                ]"
                                            >
                                                <div class="perm-role-tag">
                                                    <t-icon name="browse" size="12px" />
                                                    <span>{{ $t('organization.role.viewer') }}</span>
                                                    <span v-if="orgInfo?.my_role === 'viewer'" class="me-badge">{{
                                                        $t('common.me')
                                                    }}</span>
                                                </div>
                                                <div class="perm-items">
                                        ...
                                        <t-loading :loading="membersLoading">
                                            <div class="members-list">
                                                ...
                                                >
                                                    <div
                                                        class="member-avatar"
                                                        :class="{ 'is-me': member.user_id === authStore.currentUserId }"
                                                    >
                                                    ...
                                                    <div class="member-info">
                                                        <span class="member-name">
                                                            ...
                                                            <span
                                                                v-if="member.user_id === authStore.currentUserId"
                                                                class="me-tag"
                                                                >{{ $t('common.me') }}</span
                                                            >
                                                        </span>
                                                    ...
                                                    <div class="member-role">
                                                        ...
                                                        <t-tag v-else size="small" :theme="getRoleTheme(member.role)">
                                                            ...
                                                            <span v-if="isOwnerMember(member)"
                                                    ...
                                                    >
                                                        <t-tooltip
                                                            v-if="member.user_type === 'ldap_user'"
                                                            :content="$t('organization.transferMember')"
                                                        >
                                                            <t-button
                                                                variant="text"
                                                                size="small"
                                                        ...
                                                        <t-popconfirm
                                                            :content="
                                                                $t('organization.detail.removeMemberConfirm', {
                                ...
                                <div v-show="currentSection === 'joinRequests'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            {{ $t('organization.settings.joinRequestsDesc') }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        <t-loading :loading="joinRequestsLoading">
                                            <div
                                                v-if="joinRequests.length === 0 && !joinRequestsLoading"
                                                class="empty-join-requests"
                                            >
                                                ...
                                                >
                                                    <div class="request-user">
                                                        ...
                                                        <div class="request-info">
                                                            ...
                                                            <p v-if="req.message" class="request-message">
                                                                {{ req.message }}
                                                            </p>
                                                            <span
                                                                v-if="req.request_type === 'upgrade' && req.prev_role"
                                                                class="request-prev-role"
                                                            >
                                                                {{ $t('organization.upgrade.currentRole') }}：{{
                                                                    roleLabel(req.prev_role)
                                                                }}
                                                                → {{ roleLabel(req.requested_role) }}
                                                            </span>
                                                            <span v-else class="request-requested-role"
                                                                >{{ $t('organization.invite.requestRole') }}：{{
                                                                    roleLabel(req.requested_role)
                                                                }}</span
                                                            >
                                                    ...
                                                    <div class="request-actions">
                                                        <div class="request-assign-role">
                                                            <span class="request-assign-label">{{
                                                        ...
                                                        <t-button
                                                            theme="primary"
                                                            size="small"
                                                            :loading="reviewingRequestId === req.id"
                                ...
                                <div v-show="currentSection === 'sharedKb'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description permission-calc-hint">
                                            <t-tooltip
                                                :content="$t('organization.settings.permissionCalcTip')"
                                                placement="top"
                                            >
                                    ...
                                    <div class="settings-group">
                                        <t-loading :loading="sharesLoading">
                                            <div
                                                v-if="sharedKnowledgeBases.length === 0 && !sharesLoading"
                                                class="empty-shared"
                                            >
                                                <div class="empty-icon">
                                                    <img
                                            ...
                                            <div v-else class="shared-list">
                                                ...
                                                >
                                                    ...
                                                    <div class="shared-permissions">
                                                        <t-tooltip
                                                            :content="$t('organization.settings.sharePermissionLabel')"
                                                            placement="top"
                                                        >
                                                            <t-tag
                                                                size="small"
                                                                :theme="getPermissionTheme(share.permission)"
                                                                variant="outline"
                                                                class="perm-tag"
                                                            >
                                                        ...
                                                        >
                                                            <t-tag
                                                                ...
                                                                :theme="
                                                                    getPermissionTheme(
                                                                        share.my_permission ?? share.permission
                                                                    )
                                                                "
                                                                class="perm-tag"
                                                            >
                                                    ...
                                                    <t-popconfirm
                                                        ...
                                                        :content="
                                                            $t('organization.settings.removeShareConfirm', {
                                                                name:
                                                                    share.knowledge_base_name || share.knowledge_base_id
                                                            })
                                                        "
                                                        :confirm-btn="{
                                                            content: $t('common.confirm'),
                                                    ...
                                                    >
                                                        <t-tooltip
                                                            :content="$t('organization.settings.removeShareFromOrg')"
                                                            placement="top"
                                                        >
                                                            <t-button
                                                                variant="text"
                                ...
                                <div v-show="currentSection === 'sharedAgents'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            {{ $t('organization.settings.sharedAgentsDesc') }}
                                        </p>
                                        <p class="section-description permission-calc-hint">
                                            <t-tooltip
                                                :content="$t('organization.settings.sharedAgentsKbHint')"
                                                placement="top"
                                                :show-delay="300"
                                            >
                                                <span class="hint-inner">
                                    ...
                                    <div class="settings-group">
                                        <div v-if="sharedAgents.length === 0" class="empty-shared">
                                            ...
                                            <p class="empty-subtext">
                                                {{ $t('organization.settings.noSharedAgentsTip') }}
                                            </p>
                                        </div>
                                        <div v-else class="shared-list">
                                            <div
                                            ...
                                            >
                                                <div class="shared-icon shared-icon-agent-wrap">
                                                    <AgentAvatar
                                                        :name="share.agent_name || share.agent_id"
                                                        size="small"
                                                    />
                                                </div>
                                                <div class="shared-info">
                                                    <span class="shared-name">{{
                                                        share.agent_name || share.agent_id
                                                    }}</span>
                                                    <div class="shared-meta">
                                                        <span v-if="share.shared_by_username" class="shared-by"
                                                            ><t-icon name="user" size="12px" />{{
                                                ...
                                                <t-popconfirm
                                                    v-if="isAdmin"
                                                    :content="
                                                        $t('organization.settings.removeAgentShareConfirm', {
                                                            name: share.agent_name || share.agent_id
                                                        })
                                                    "
                                                    :confirm-btn="{ content: $t('common.confirm'), theme: 'danger' }"
                                                    :cancel-btn="{ content: $t('common.cancel') }"
                                                    @confirm="handleRemoveAgentShare(share)"
                                                >
                                                    <t-button
                                                        variant="text"
                                                        size="small"
                                ...
                                <Transition name="agent-scope-popover-fade">
                                    ...
                                    >
                                        <div class="agent-scope-popover-card">
                                            <div class="agent-scope-popover-name">
                                                {{
                                                    agentScopePopover.share.agent_name ||
                                                    agentScopePopover.share.agent_id
                                                }}
                                            </div>
                                            <div class="agent-scope-popover-meta">
                                                <span
                                                    v-if="agentScopePopover.share.shared_by_username"
                                                    class="popover-meta-item"
                                                >
                                                    <t-icon name="user" size="12px" />
                                                    {{ agentScopePopover.share.shared_by_username }}
                                                </span>
                                                <span class="popover-meta-item">
                                                    <t-icon name="time" size="12px" />
                                                    {{ formatDate(agentScopePopover.share.created_at) }}
                                                </span>
                                            </div>
                                            ...
                                            <template v-if="getAgentScopeTags(agentScopePopover.share).length">
                                                ...
                                                <div class="agent-scope-popover-section-title">
                                                    {{ $t('agent.shareScope.title') }}
                                                </div>
                                                <div
                                                    v-for="(tag, idx) in getAgentScopeTags(agentScopePopover.share)"
                                                    :key="idx"
                                                    class="agent-scope-popover-row"
                                                >
                                                    {{ tag }}
                                                </div>
                                            </template>
        ...
        >
            <div class="upgrade-dialog-content">
                ...
                <div class="upgrade-form-item">
                    ...
                    <t-select
                        v-model="upgradeForm.requested_role"
                        :options="upgradeRoleOptions"
        ...
        <t-dialog
            ...
            :confirm-btn="{
                content: $t('organization.addMember.confirmBtn'),
        ...
        <t-dialog
            ...
            :header="$t('organization.transferMember')"
            :confirm-btn="{
                content: $t('common.confirm'),
                loading: transferSubmitting,
                disabled: !transferTargetOrgId
            }"
            :cancel-btn="$t('common.cancel')"
            @confirm="confirmTransferMember"
            width="420px"
        >
            <div class="add-member-dialog">
                <p class="add-member-tip">
                    {{
                        $t('organization.transferMemberDesc', {
                            name: transferTargetMember ? memberPrimaryLabel(transferTargetMember) : ''
                        })
                    }}
                </p>

                <div class="add-member-field">
                    <label>{{ $t('organization.transferTargetOrg') }}</label>
                    <t-select
                        v-model="transferTargetOrgId"
                        :placeholder="$t('organization.transferTargetOrgPlaceholder')"
                        :options="transferOrgOptions"
                    />
                    <p v-if="transferOrgOptions.length === 0" class="field-hint">
                        {{ $t('organization.transferNoOtherOrg') }}
                    </p>
                </div>
            </div>
        </t-dialog>
...
const transferTargetMember = ref<OrganizationMember | null>(null);
const transferTargetOrgId = ref<string>('');
const adminOtherOrgs = ref<Organization[]>([]);
...
const fetchSharedKBs = async () => {
    ...
    try {
        const [kbRes, agentRes] = await Promise.all([listOrgShares(props.orgId), listOrgAgentShares(props.orgId)]);
    ...
    try {
        ...
        if (res.success && res.data) {
            ...
            joinRequests.value.forEach((r) => {
                const rRole =
                    r.requested_role === 'admin' || r.requested_role === 'editor' || r.requested_role === 'viewer'
                        ? r.requested_role
                        : 'viewer';
...
const handleApproveRequest = async (req: JoinRequestResponse) => {
    ...
    const assignRole =
        assignRoleMap.value[req.id] ??
        (req.requested_role === 'admin' || req.requested_role === 'editor' ? req.requested_role : 'viewer');
    try {
...
const handleSave = async () => {
    ...
    try {
        if (isCreateMode.value) {
            // 创建模式
            const result = await orgStore.create(formData.value.name.trim(), formData.value.description.trim());
            if (result) {
...
// 变更空间：打开变更空间对话框
const openTransferDialog = async (member: OrganizationMember) => {
    transferTargetMember.value = member;
    transferTargetOrgId.value = '';
    ...
    try {
        ...
        if (res.success && res.data) {
            adminOtherOrgs.value = (res.data.organizations || []).filter(
                (org) => org.id !== props.orgId && org.my_role === 'admin'
            );
        }
    } catch {
        adminOtherOrgs.value = [];
    }
};

// 变更空间选项
const transferOrgOptions = computed(() =>
    adminOtherOrgs.value.map((org) => ({
        label: org.name,
        value: org.id
    }))
);
...
const confirmTransferMember = async () => {
    if (!props.orgId || !transferTargetMember.value || !transferTargetOrgId.value) return;

    transferSubmitting.value = true;
    try {
        const res = await transferMemberSpace(props.orgId, {
            tenant_id: transferTargetMember.value.tenant_id,
            target_org_id: transferTargetOrgId.value
        });
        if (res.success) {
            MessagePlugin.success(
                t('organization.memberTransferred', { name: memberPrimaryLabel(transferTargetMember.value) })
            );
            showTransferDialog.value = false;
            fetchMembers();
        } else {
            MessagePlugin.error(res.message || t('organization.memberTransferFailed'));
        }
    } catch (error: any) {
        MessagePlugin.error(error?.message || t('organization.memberTransferFailed'));
    } finally {
...
function getAgentScopeTags(share: AgentShareResponse): string[] {
    ...
    if (share.scope_web_search !== undefined) {
        tags.push(
            `${t('agent.shareScope.webSearch')}：${share.scope_web_search ? t('agent.shareScope.enabled') : t('agent.shareScope.disabled')}`
        );
    }
