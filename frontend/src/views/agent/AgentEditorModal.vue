                            ...
                            <div class="content-wrapper">
                                ...
                                <div v-show="currentSection === 'basic'" class="section">
                                    <div class="section-header">
                                        <div class="section-header-title">
                                            ...
                                            <t-tooltip
                                                v-if="isBuiltinAgent"
                                                :content="$t('agentEditor.builtinHint')"
                                                placement="top"
                                            >
                                                <span
                                                    class="builtin-agent-hint"
                                                    tabindex="0"
                                                    role="img"
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div v-if="mode === 'edit' && props.agent?.id" class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <div class="agent-id-field">
                                                    <code class="agent-id-value" :title="props.agent.id">{{
                                                        props.agent.id
                                                    }}</code>
                                        ...
                                        <!-- 智能体类型（仅智能推理模式下显示） -->
                                        <div
                                            v-if="isAgentMode && agentTypePresets.length > 0"
                                            class="setting-row setting-row--emphasize"
                                        ...
                                        >
                                            <div class="setting-info">
                                                ...
                                                <p v-if="activeAgentTypePreset" class="desc agent-type-preset-desc">
                                                    {{ agentTypePresetDescription(activeAgentTypePreset) }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-select
                                                ...
                                                >
                                                    <template #option="{ option }">
                                                        <div class="agent-type-option">
                                                            <span class="agent-type-option-label">{{
                                                                option.label
                                                            }}</span>
                                                            <span v-if="option.desc" class="agent-type-option-desc">{{
                                                                option.desc
                                                            }}</span>
                                                        </div>
                                                    </template>
                                        ...
                                        <div class="setting-row" data-guide="agent-create-name">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t('agent.editor.name') }}
                                                    <span v-if="!isBuiltinAgent" class="required">*</span></label
                                                >
                                            ...
                                            <div class="setting-control">
                                                <div class="name-input-wrapper">
                                                    ...
                                                    >
                                                        <t-icon
                                                            :name="isAgentMode ? 'control-platform' : 'chat'"
                                                            size="24px"
                                                        />
                                                    </div>
                                            ...
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t('agentEditor.desc.systemPrompt')
                                                        ...
                                                        isBuiltinAgent ? $t('agentEditor.desc.leaveEmptyDefault') : ''
                                                    }}
                                                </p>
                                                <div class="placeholder-tags">
                                                    ...
                                                    <t-tooltip
                                                        ...
                                                        :content="
                                                            ...
                                                            $t('agentEditor.placeholders.clickToInsert')
                                                        "
                                                        placement="top"
                                                    >
                                                        <span
                                            ...
                                            >
                                                ...
                                                <div v-if="isAgentMode" class="textarea-with-template">
                                                    <t-textarea
                                                        ...
                                                        :disabled="isLdapUser && isBuiltinAgent"
                                                    />
                                                    ...
                                                    >
                                                        <div class="placeholder-popup">
                                                            <div
                                                                ...
                                                                @mousedown.prevent="
                                                                    insertPlaceholder(placeholder.name, true)
                                                                "
                                                    ...
                                                    >
                                                        <div class="placeholder-popup">
                                                            <div
                                                                ...
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active: selectedContextPlaceholderIndex === index
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertContextPlaceholder(placeholder.name, true)
                                                                "
                                        ...
                                        <div v-if="!isAgentMode" class="setting-row setting-row-vertical">
                                            ...
                                            <div class="setting-control setting-control-full">
                                                <div class="intent-prompts-editor">
                                                    <div
                                                        v-if="intentPromptTemplates.length === 0"
                                                        class="prompt-disabled-hint"
                                                    >
                                                        {{ $t('agentEditor.intentPrompts.empty') }}
                                                    </div>
                                                    <template v-else>
                                                        <div
                                                            class="intent-toggle-group"
                                                            role="tablist"
                                                            :aria-label="$t('agentEditor.intentPrompts.intentLabel')"
                                                        >
                                                            <t-button
                                                                v-for="template in intentPromptTemplates"
                                                                :key="template.id"
                                                                theme="default"
                                                                variant="outline"
                                                                size="small"
                                                                class="intent-toggle-btn"
                                                                :class="{
                                                                    'intent-toggle-btn--active':
                                                                        selectedIntent === template.id
                                                                }"
                                                                :disabled="props.readOnly"
                                                                @click="selectedIntent = template.id"
                                                            >
                                                                <span class="intent-toggle-label">
                                                                    {{ template.name || template.id }}
                                                                    <t-tooltip
                                                                        v-if="isIntentCustomized(template.id)"
                                                                        :content="
                                                                            $t('agentEditor.intentPrompts.customized')
                                                                        "
                                                                        placement="top"
                                                                    >
                                                        ...
                                                        <p v-if="currentIntentTemplateDesc" class="intent-active-desc">
                                                            {{ currentIntentTemplateDesc }}
                                                        </p>

                                                        <div
                                                            v-if="placeholderData.system_prompt.length > 0"
                                                        ...
                                                        >
                                                            ...
                                                            <t-tooltip
                                                                v-for="placeholder in placeholderData.system_prompt"
                                                                :key="placeholder.name"
                                                                :content="
                                                                    placeholder.description +
                                                                    $t('agentEditor.placeholders.clickToInsert')
                                                        ...
                                                        <div class="textarea-with-template">
                                                            <t-textarea
                                                                ref="intentPromptTextareaRef"
                                                                v-model="intentEditorValue"
                                                                class="system-prompt-textarea"
                                                                :autosize="{ minRows: 10, maxRows: 25 }"
                                                                :disabled="props.readOnly || !selectedIntent"
                                                                :placeholder="
                                                                    currentIntentTemplate?.content ||
                                                                    $t('agentEditor.intentPrompts.promptPlaceholder')
                                                                "
                                                            ...
                                                            <PromptTemplateSelector
                                                                ...
                                                                @reset-default="resetCurrentIntentPrompt"
                                                            />
                                                        </div>
                                                        ...
                                                        <Teleport to="body">
                                                            <div
                                                                v-if="
                                                                    intentPromptPopup.show &&
                                                                    filteredIntentPlaceholders.length > 0
                                                                "
                                                                class="placeholder-popup-wrapper"
                                                                :style="intentPromptPopup.style"
                                                            >
                                                                <div class="placeholder-popup">
                                                                    <div
                                                                        v-for="(
                                                                            placeholder, index
                                                                        ) in filteredIntentPlaceholders"
                                                                        :key="placeholder.name"
                                                                        class="placeholder-item"
                                                                        :class="{
                                                                            active:
                                                                                intentPromptPopup.selectedIndex ===
                                                                                index
                                                                        }"
                                                                        @mousedown.prevent="
                                                                        ...
                                                                        "
                                                                        @mouseenter="
                                                                            intentPromptPopup.selectedIndex = index
                                                                        "
                                                                    >
                                                                        <div class="placeholder-name">
                                        ...
                                        <div class="setting-row" data-guide="agent-create-model">
                                            ...
                                            <div class="setting-control">
                                                <ModelSelector
                                                    ...
                                                    :disabled="isLdapUser && isBuiltinAgent"
                                                    :hide-add-model="isLdapUser && isBuiltinAgent"
                                                    @update:selected-model-id="
                                                        (val: string) => (formData.config.model_id = val)
                                                    "
                                ...
                                <div v-show="currentSection === 'multimodal'" class="section">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row" data-guide="agent-create-multimodal">
                                            ...
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.image_upload_enabled"
                                                    :disabled="isLockedMultimodal"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="formData.config.image_upload_enabled" class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t('agentEditor.imageUpload.storageProviderDesc') }}
                                                </p>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <t-select
                                                    ...
                                                    style="width: 280px"
                                                    :placeholder="
                                                        $t('agentEditor.imageUpload.storageProviderPlaceholder')
                                                    "
                                                    clearable
                                                    :disabled="isLockedMultimodal"
                                                >
                                                    <t-option
                                                        value=""
                                                        :label="$t('agentEditor.imageUpload.storageDefault')"
                                                    />
                                                    <t-option
                                                    ...
                                                    >
                                                        <span class="select-option-with-tag">
                                                            ...
                                                            <t-tag
                                                                ...
                                                                size="small"
                                                                >{{
                                                                    $t('agentEditor.imageUpload.notConfigured')
                                                                }}</t-tag
                                                            >
                                                        </span>
                                                    </t-option>
                                        ...
                                        <div class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.audio_upload_enabled"
                                                    :disabled="isLockedMultimodal"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="formData.config.audio_upload_enabled" class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <ModelSelector
                                                    ...
                                                    :all-models="allModels"
                                                    @update:selected-model-id="
                                                        (val: string) => (formData.config.asr_model_id = val)
                                                    "
                                ...
                                <div v-show="currentSection === 'conversation' && !isAgentMode" class="section">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div
                                            v-if="formData.config.multi_turn_enabled && !isAgentMode"
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                        ...
                                        >
                                            ...
                                            <div class="setting-control">
                                                <ModelSelector
                                                    ...
                                                    @update:selected-model-id="
                                                        (val: string) =>
                                                            (formData.config.query_understand_model_id = val)
                                                    "
                                                    @add-model="handleAddModel('llm')"
                                                ...
                                                <div class="textarea-with-template">
                                                    <t-textarea
                                                        ...
                                                        :placeholder="
                                                            ...
                                                            $t('agent.editor.rewritePromptSystemPlaceholder')
                                                        "
                                                ...
                                                <Teleport to="body">
                                                    <div
                                                        v-if="
                                                            ...
                                                            filteredRewriteSystemPlaceholders.length > 0
                                                        "
                                                        class="placeholder-popup-wrapper"
                                                    ...
                                                    >
                                                        <div class="placeholder-popup">
                                                            <div
                                                                ...
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active: rewriteSystemPopup.selectedIndex === index
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertGenericPlaceholder(
                                                                        'rewriteSystem',
                                                ...
                                                <div class="placeholder-tags" v-if="rewritePlaceholders.length > 0">
                                                    ...
                                                    >
                                                        <span
                                                            class="placeholder-tag"
                                                            @click="
                                                                handlePlaceholderClick('rewriteUser', placeholder.name)
                                                            "
                                                            v-text="'{{' + placeholder.name + '}}'"
                                                        ></span>
                                                    </t-tooltip>
                                                ...
                                                <div class="textarea-with-template">
                                                    <t-textarea
                                                        ...
                                                        :placeholder="
                                                            ...
                                                            $t('agent.editor.rewritePromptUserPlaceholder')
                                                        "
                                                        :autosize="{ minRows: 4, maxRows: 10 }"
                                                ...
                                                <Teleport to="body">
                                                    <div
                                                        v-if="
                                                            ...
                                                            filteredRewriteUserPlaceholders.length > 0
                                                        "
                                                        class="placeholder-popup-wrapper"
                                                    ...
                                                    >
                                                        <div class="placeholder-popup">
                                                            <div
                                                                ...
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active: rewriteUserPopup.selectedIndex === index
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertGenericPlaceholder(
                                                                        'rewriteUser',
                                ...
                                <div v-show="currentSection === 'tools' && isAgentMode" class="section">
                                    ...
                                    <div class="tools-overview">
                                        <div class="tools-overview-row">
                                            <!-- builtin-smart 智能体不显示知识库状态 -->
                                            <div v-if="props.agent?.id !== 'builtin-smart'" class="tools-status-chip">
                                                <t-icon name="folder" />
                                                ...
                                                <template v-else>
                                                    <span class="tools-status-metric">
                                                        <strong>{{ ragKbCount }}</strong>
                                                        {{ $t('agentEditor.tools.kbMetricRag') }}
                                                    </span>
                                                    <span class="tools-status-sep">·</span>
                                                    <span class="tools-status-metric">
                                                        <strong>{{ wikiKbCount }}</strong>
                                                        {{ $t('agentEditor.tools.kbMetricWiki') }}
                                                    </span>
                                                </template>
                                            </div>
                                            <div
                                                v-if="inactiveToolCount > 0"
                                                class="tools-status-chip tools-status-chip--warn"
                                            >
                                    ...
                                    <div class="settings-group">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <header class="tool-group-header">
                                                            ...
                                                            <span
                                                                v-if="group.key === 'wiki_edit'"
                                                                class="tool-group-warning"
                                                            >
                                                                <t-icon name="error-circle" />
                                                        ...
                                                        <div class="tool-grid">
                                                            <t-checkbox
                                                                ...
                                                                :class="[
                                                                    'tool-card',
                                                                    {
                                                                        'tool-card--disabled': tool.disabled,
                                                                        'tool-card--danger': tool.danger
                                                                    }
                                                                ]"
                                                            >
                                                ...
                                                <div class="effective-tools">
                                                    ...
                                                    <template v-else>
                                                        <span
                                                            ...
                                                            :class="[
                                                                'effective-chip',
                                                                { 'effective-chip--inactive': !item.active }
                                                            ]"
                                                            :title="item.reason || ''"
                                                        >
                                                            <span class="effective-chip-label">{{ item.label }}</span>
                                                            <span v-if="!item.active" class="effective-chip-reason">{{
                                                                item.reason
                                                            }}</span>
                                                        </span>
                                                    </template>
                                        ...
                                        <div
                                            v-if="!isLdapUser || !isBuiltinAgent || props.agent?.id === 'builtin-smart'"
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                                <label>{{ $t('agent.editor.thinking') }}</label>
                                        ...
                                        <div
                                            v-if="
                                                !isLdapUser ||
                                                !isBuiltinAgent ||
                                                props.agent?.id !== 'builtin-wiki-researcher'
                                            "
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                        ...
                                        <div class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <t-radio-group v-model="mcpSelectionMode" :disabled="isLdapUser">
                                        ...
                                        <!-- 选择指定 MCP 服务 -->
                                        <div
                                            v-if="mcpSelectionMode === 'selected' && mcpOptions.length > 0"
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                ...
                                <div v-show="currentSection === 'skills' && isAgentMode" class="section">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <t-radio-group
                                                    v-model="skillsSelectionMode"
                                                    :disabled="isLdapSkillsDisabled"
                                                >
                                                    <t-radio-button value="all">{{
                                        ...
                                        <!-- 沙箱未就绪提示（仅展示，不禁用配置） -->
                                        <div
                                            v-if="!skillsAvailable && filteredSkillOptions.length > 0"
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                                <p class="desc empty-hint">
                                                    {{ $t('agent.editor.sandboxUnavailableHint') }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <!-- 选择指定 Skills -->
                                        <div
                                            v-if="skillsSelectionMode === 'selected' && filteredSkillOptions.length > 0"
                                            class="setting-row setting-row-vertical"
                                        >
                                            <div class="setting-info">
                                        ...
                                        <!-- 无可用 Skills 提示 -->
                                        <div v-if="filteredSkillOptions.length === 0" class="setting-row">
                                            <div class="setting-info">
                                                <p class="desc empty-hint">
                                        ...
                                        <div class="skill-info-box">
                                            ...
                                            <div class="info-content">
                                                <p>
                                                    <strong>{{ $t('agent.editor.skillsInfoTitle') }}</strong>
                                                </p>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div v-if="kbSelectionMode === 'selected'" class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                ...
                                                >
                                                    <t-option-group
                                                        v-if="filteredMyKbOptions.length"
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                class="kb-option-item"
                                                                :title="kb.disabled ? kb.disabledReason : ''"
                                                            >
                                                                <span
                                                                    class="kb-option-icon"
                                                                    :class="kb.type === 'faq' ? 'faq-icon' : 'doc-icon'"
                                                                >
                                                                    <t-icon
                                                                        :name="
                                                                            kb.type === 'faq'
                                                                ...
                                                                <span v-if="kb.ragEnabled" class="kb-option-tag tag-rag"
                                                                    >RAG</span
                                                                >
                                                                <span
                                                                    v-if="kb.wikiEnabled"
                                                                    class="kb-option-tag tag-wiki"
                                                                    >Wiki</span
                                                                >
                                                                <span class="kb-option-count">{{ kb.count || 0 }}</span>
                                                                <span
                                                                    v-if="kb.disabled"
                                                                    class="kb-option-disabled-hint"
                                                                    >{{ kb.disabledReason }}</span
                                                                >
                                                            </div>
                                                        </t-option>
                                                    </t-option-group>
                                                    <t-option-group
                                                        v-if="filteredSharedKbOptions.length"
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <span
                                                                    ...
                                                                    >Wiki</span
                                                                >
                                                                <span v-if="kb.orgName" class="kb-option-org">{{
                                                                    kb.orgName
                                                                }}</span>
                                                                <span class="kb-option-count">{{ kb.count || 0 }}</span>
                                                                <span
                                        ...
                                        <div v-if="hasKnowledgeBase" class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t('agent.editor.retrieveKBOnlyWhenMentionedDesc') }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.retrieve_kb_only_when_mentioned"
                                                    :disabled="isLdapUser && isBuiltinAgent"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <!-- LDAP 用户的 smart-reasoning 也需要配置 ReRank 模型（即使不使用知识库） -->
                                        <div
                                            v-if="
                                                hasKnowledgeBase ||
                                                (isLdapUser && isBuiltinAgent && props.agent?.id === 'builtin-smart')
                                            "
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    ...
                                                    <template v-if="!needsRerankModel">
                                                        <br />
                                                        <span class="hint">{{
                                                            $t('agent.editor.rerankModelOptionalHint')
                                                        }}</span>
                                                    </template>
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <ModelSelector
                                                    ...
                                                    "
                                                    @update:selected-model-id="
                                                        (val: string) => (formData.config.rerank_model_id = val)
                                                    "
                                        ...
                                        <div v-if="hasFaqKnowledgeBase" class="faq-strategy-section">
                                            ...
                                            <div v-if="formData.config.faq_priority_enabled" class="setting-row">
                                                ...
                                                <div class="setting-control">
                                                    <div class="slider-wrapper">
                                                        <t-slider
                                                            v-model="formData.config.faq_direct_answer_threshold"
                                                            :min="0.7"
                                                            :max="1"
                                                            :step="0.05"
                                                        />
                                                        <span class="slider-value">{{
                                                            formData.config.faq_direct_answer_threshold?.toFixed(2)
                                                        }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div v-if="formData.config.faq_priority_enabled" class="setting-row">
                                                ...
                                                <div class="setting-control">
                                                    <div class="slider-wrapper">
                                                        <t-slider
                                                            v-model="formData.config.faq_score_boost"
                                                            :min="1"
                                                            :max="2"
                                                            :step="0.1"
                                                        />
                                                        <span class="slider-value"
                                                            >{{ formData.config.faq_score_boost?.toFixed(1) }}x</span
                                                        >
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div v-show="currentSection === 'websearch'" class="section">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div v-if="formData.config.web_search_enabled" class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <t-select
                                                    ...
                                                    style="width: 240px"
                                                    :disabled="isLockedWebSearch"
                                                >
                                                    <t-option
                                                        v-for="p in webSearchProviderOptions"
                                                        :key="p.id"
                                                        :value="p.id"
                                                        :label="p.name"
                                                    >
                                        ...
                                        <!-- 网络搜索最大结果数（LDAP用户隐藏） -->
                                        <div
                                            v-if="formData.config.web_search_enabled && !isLockedWebSearch"
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                            ...
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="formData.config.web_search_max_results"
                                                        :min="1"
                                                        :max="10"
                                                    />
                                                    <span class="slider-value">{{
                                        ...
                                        <div
                                            v-if="
                                                formData.config.web_search_enabled && formData.config.web_fetch_enabled
                                            "
                                            class="setting-row"
                                        >
                                            <div class="setting-info">
                                        ...
                                        <div class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    ...
                                                    />
                                                    <span class="slider-value">{{
                                                        formData.config.keyword_threshold?.toFixed(2)
                                                    }}</span>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="textarea-with-template">
                                                        <t-textarea
                                                            ...
                                                            :placeholder="
                                                                ...
                                                                $t('agent.editor.fallbackResponsePlaceholder')
                                                            "
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <span
                                                                class="placeholder-tag"
                                                                @click="
                                                                    handlePlaceholderClick('fallback', placeholder.name)
                                                                "
                                                                v-text="'{{' + placeholder.name + '}}'"
                                                            ></span>
                                                        </t-tooltip>
                                                    ...
                                                    <div class="textarea-with-template">
                                                        <t-textarea
                                                            ...
                                                            :placeholder="
                                                                ...
                                                                $t('agent.editor.fallbackPromptPlaceholder')
                                                            "
                                                            :autosize="{ minRows: 4, maxRows: 10 }"
                                                    ...
                                                    <Teleport to="body">
                                                        <div
                                                            v-if="
                                                                ...
                                                                filteredFallbackPlaceholders.length > 0
                                                            "
                                                            class="placeholder-popup-wrapper"
                                                        ...
                                                        >
                                                            <div class="placeholder-popup">
                                                                <div
                                                                    ...
                                                                    :class="{
                                                                        active:
                                                                            fallbackPromptPopup.selectedIndex === index
                                                                    }"
                                                                    @mousedown.prevent="
                                                                        insertGenericPlaceholder(
                                                                            'fallback',
                                ...
                                <!-- 共享管理（仅编辑模式且非内置智能体） -->
                                <div
                                    v-if="props.mode === 'edit' && props.agent?.id && !props.agent?.is_builtin"
                                ...
                                <!-- IM集成（仅编辑模式） -->
                                <div
                                    v-if="props.mode === 'edit' && props.agent?.id && currentSection === 'im'"
                                    class="section"
                                >
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            ...
                                            <a
                                                href="https://github.com/Tencent/CloudClow/blob/main/docs/IM%E9%9B%86%E6%88%90%E5%BC%80%E5%8F%91%E6%96%87%E6%A1%A3.md"
                                                target="_blank"
...
import { AGENT_EDITOR_FOCUS_SECTION_EVENT, markContextualGuideDone } from '@/config/contextualGuides';
...
// LDAP 用户的内置智能体（builtin-smart / builtin-wiki-researcher）多模态配置锁定为系统默认，不可修改
const isLockedMultimodal = computed(
    () =>
        isLdapUser.value &&
        props.agent?.is_builtin &&
        (props.agent?.id === 'builtin-smart' || props.agent?.id === 'builtin-wiki-researcher')
);
// LDAP 用户的 builtin-smart 网络搜索配置锁定为系统默认（qwen 引擎），不可修改
const isLockedWebSearch = computed(
    () => isLdapUser.value && props.agent?.is_builtin && props.agent?.id === 'builtin-smart'
);
// 网络搜索提供者选项：LDAP 锁定或已选用系统 qwen 时，补充系统默认 qwen 引擎项以便展示
const webSearchProviderOptions = computed(() => {
    const list = webSearchProviderList.value;
    const needQwen = isLockedWebSearch.value || formData.value.config.web_search_provider_id === 'qwen';
    if (needQwen && !list.some((p: WebSearchProviderEntity) => p.id === 'qwen')) {
        return [...list, { id: 'qwen', name: '通义千问联网搜索', is_default: false } as WebSearchProviderEntity];
    }
    return list;
});
...
// LDAP 用户的内置智能体不需要排除 data-query 技能（共享空间的 skill 均可使用）
const filteredSkillOptions = computed(() => {
    return skillOptions.value;
});

// LDAP 用户的内置智能体允许编辑 skills 配置
const isLdapSkillsDisabled = computed(() => {
    if (!isLdapUser.value || !props.agent?.is_builtin) return false;
    // wiki-researcher 的 skills 可查看、可编辑（默认为 none 但用户可切换）
    return false;
});
...
const allTools = computed(() => [
    ...
    {
        value: 'wiki_search',
        label: t('agentEditor.tools.wikiSearch'),
        description: t('agentEditor.tools.wikiSearchDesc'),
        group: 'wiki_read'
    },
    {
        value: 'wiki_read_page',
        label: t('agentEditor.tools.wikiReadPage'),
        description: t('agentEditor.tools.wikiReadPageDesc'),
        group: 'wiki_read'
    },
    {
        value: 'wiki_read_source_doc',
        label: t('agentEditor.tools.wikiReadSourceDoc'),
        description: t('agentEditor.tools.wikiReadSourceDocDesc'),
        group: 'wiki_read'
    },
    {
        value: 'wiki_flag_issue',
        label: t('agentEditor.tools.wikiFlagIssue'),
        description: t('agentEditor.tools.wikiFlagIssueDesc'),
        group: 'wiki_read'
    },
    // Wiki 编辑类（会直接修改 Wiki 内容）
    {
        value: 'wiki_write_page',
        label: t('agentEditor.tools.wikiWritePage'),
        description: t('agentEditor.tools.wikiWritePageDesc'),
        group: 'wiki_edit',
        danger: true
    },
    {
        value: 'wiki_replace_text',
        label: t('agentEditor.tools.wikiReplaceText'),
        description: t('agentEditor.tools.wikiReplaceTextDesc'),
        group: 'wiki_edit',
        danger: true
    },
    {
        value: 'wiki_rename_page',
        label: t('agentEditor.tools.wikiRenamePage'),
        description: t('agentEditor.tools.wikiRenamePageDesc'),
        group: 'wiki_edit',
        danger: true
    },
    {
        value: 'wiki_delete_page',
        label: t('agentEditor.tools.wikiDeletePage'),
        description: t('agentEditor.tools.wikiDeletePageDesc'),
        group: 'wiki_edit',
        danger: true
    },
    // Wiki 巡检类
    {
        value: 'wiki_read_issue',
        label: t('agentEditor.tools.wikiReadIssue'),
        description: t('agentEditor.tools.wikiReadIssueDesc'),
        group: 'wiki_issue'
    },
    {
        value: 'wiki_update_issue',
        label: t('agentEditor.tools.wikiUpdateIssue'),
        description: t('agentEditor.tools.wikiUpdateIssueDesc'),
        group: 'wiki_issue'
    },
    // 数据分析
    {
...
const missKindToReason = (kind: RequirementMissKind): string | undefined => {
    switch (kind) {
        ...
        case 'needsWiki':
            return t('agentEditor.tools.requiresWikiKb');
        case 'needsRag':
        case 'needsGraph':
        case 'needsFaq':
            return t('agentEditor.tools.requiresRagKb');
        case 'none':
        default:
            return undefined;
    }
...
const groupedAvailableTools = computed(() => {
    ...
    let groups = toolGroups.value
        .map((g) => ({
            ...g,
            tools: map[g.key] || []
        }))
        .filter((g) => g.tools.length > 0);
    // LDAP 用户内置智能体限制工具分组展示
    if (isLdapUser.value && props.agent?.is_builtin) {
        const agentId = props.agent.id;
        if (agentId === 'builtin-wiki-researcher') {
            const allowed = new Set(['rag', 'wiki_read']);
            groups = groups.filter((g) => allowed.has(g.key));
        }
        if (agentId === 'builtin-smart') {
            // builtin-smart: 不展示 RAG、Wiki 读取、Wiki 编辑、Wiki 巡检、数据分析
            const hidden = new Set(['rag', 'wiki_read', 'wiki_edit', 'wiki_issue', 'data']);
...
const effectiveTools = computed(() => {
    ...
    // LDAP 用户内置智能体只展示真正可用的工具，隐藏所有因缺失能力而被禁用的项
    const hideDisabled = isLdapUser.value && props.agent?.is_builtin;
    for (const tool of availableTools.value) {
...
const navItems = computed(() => {
    ...
    // LDAP 用户内置智能体特殊处理
    const isLdapBuiltinWiki =
        isLdapUser.value && props.agent?.is_builtin && props.agent?.id === 'builtin-wiki-researcher';
    const isLdapBuiltinSmart = isLdapUser.value && props.agent?.is_builtin && props.agent?.id === 'builtin-smart';

    // Agent模式才显示工具配置
    if (isAgentMode.value) {
        items.push({ key: 'tools', icon: 'tools', label: t('agent.editor.toolsConfig') });
    }
    // Agent 模式下显示 Skills 配置菜单，实际能否启用由沙箱状态控制
    // LDAP 用户编辑 builtin-wiki-researcher 时也强制显示 skills 菜单
    // LDAP 用户编辑 builtin-smart 时不显示 skills 菜单（默认 selected 模式，但通过对话界面 # 按钮选择）
    if (isAgentMode.value || isLdapBuiltinWiki) {
        if (isLdapBuiltinSmart) {
            // builtin-smart LDAP: 不展示 skills 菜单
        } else {
    ...
    // 网络搜索（独立菜单）
    // LDAP 用户编辑 builtin-smart 时强制显示 websearch 菜单
    if (!isLdapBuiltinWiki && (isLdapBuiltinSmart || !(isLdapUser.value && props.agent?.is_builtin))) {
    ...
    if (isLdapUser.value && props.agent?.is_builtin) {
        const agentId = props.agent?.id;
        if (agentId === 'builtin-wiki-researcher') {
            // 业务咨询：显示 skill 选择菜单，隐藏联网菜单
            const allowed = new Set(['basic', 'model', 'knowledge', 'tools', 'skills', 'retrieval', 'multimodal']);
            return items.filter((i) => allowed.has(i.key));
        }
        if (agentId === 'builtin-smart') {
            // ReAct智能体：显示联网选择菜单，不展示 skill 选择菜单
            const allowed = new Set(['basic', 'model', 'tools', 'websearch', 'multimodal']);
            return items.filter((i) => allowed.has(i.key));
        }
    }
    return items;
...
const currentIntentTemplateDesc = computed(() => currentIntentTemplate.value?.description || '');
...
const agentType = computed({
    ...
    set: (val: AgentType) => {
        formData.value.config.agent_type = val;
    }
});
...
const kbSatisfiesPresetFilter = (
    kb: { capabilities?: KBCapabilities; ragEnabled?: boolean; wikiEnabled?: boolean; type?: string },
...
const kbSatisfiesQuickAnswerMode = (kb: {
    capabilities?: KBCapabilities;
    ragEnabled?: boolean;
}): { ok: boolean; reason: string } => {
    if (agentMode.value !== 'quick-answer') return { ok: true, reason: '' };
    const hasRag = kb.capabilities ? !!kb.capabilities.vector || !!kb.capabilities.keyword : !!kb.ragEnabled;
...
const applyAgentTypePreset = (preset: AgentTypePreset | null) => {
    ...
    if (c.system_prompt_id !== undefined) {
        ...
        if (tmpl && typeof tmpl.content === 'string') {
            ...
            if (c.system_prompt_id) {
                console.warn(
                    `[AgentType] system_prompt_id "${c.system_prompt_id}" not found in agent_system_prompt templates`
                );
            }
        }
    }
    ...
    // supported_file_types 采用"强同步"语义：切换预设类型时必须清空，
    // 否则会从上一个类型带过来残留。
            ...
            if (props.mode === 'edit' && props.agent) {
                ...
                if (!agentData.config.agent_mode) {
                    const isAgent =
                        ...
                        (agentData.config.allowed_tools && agentData.config.allowed_tools.length > 0);
                ...
                // LDAP 用户内置智能体强制配置
                if (isLdapUser.value && props.agent?.is_builtin) {
                    // 使用 is_default 标记的内置模型
                    const pickDefault = (type: string) => {
                        const list = allModels.value.filter((m) => m.type === type);
                        return list.find((m) => m.is_default) || list[0];
                    };
                    const chat = pickDefault('KnowledgeQA');
                    const rerank = pickDefault('Rerank');
                    const vlm = pickDefault('VLLM');
                    if (chat?.id) {
                        formData.value.config.model_id = chat.id;
                    }
                    if (rerank?.id) {
                    ...
                    if (props.agent.id === 'builtin-smart') {
                        // LDAP 用户内置智能体强制显示为自定义类型
                        formData.value.config.agent_type = 'custom' as AgentType;
                    }
                    // LDAP 用户的 builtin-smart 和 builtin-wiki-researcher 强制启用多模态配置
                    if (props.agent.id === 'builtin-smart' || props.agent.id === 'builtin-wiki-researcher') {
                        formData.value.config.image_upload_enabled = true;
                        if (vlm?.id) {
                            formData.value.config.vlm_model_id = vlm.id;
                        }
                        formData.value.config.image_storage_provider = ''; // 使用系统默认存储
                        formData.value.config.audio_upload_enabled = false;
                    }
                    if (props.agent.id === 'builtin-smart') {
                        // LDAP 用户 builtin-smart 网络搜索默认开启，使用通义千问联网搜索
                        formData.value.config.web_search_enabled = true;
                        formData.value.config.web_search_provider_id = 'qwen';
                        formData.value.config.web_search_max_results = 5;
                        // 最大迭代次数设置为 60 次
                        formData.value.config.max_iterations = 60;
                    }
                    if (props.agent.id === 'builtin-wiki-researcher') {
                        formData.value.config.supported_file_types = ['pdf', 'docx', 'txt', 'md', 'csv', 'xlsx', 'jpg'];
                        // LDAP 用户 builtin-wiki-researcher 默认关闭网络搜索
                ...
                if (isAgent) {
                    ...
                    // ReAct 智能体：默认开启网络搜索，使用通义千问联网搜索
                    newFormData.config.web_search_enabled = true;
                    newFormData.config.web_search_provider_id = 'qwen';
                    newFormData.config.web_search_max_results = 5;
                    // ReAct 智能体：默认最大迭代次数为 60 次
                    newFormData.config.max_iterations = 60;
                } else {
...
const initKbSelectionMode = () => {
    ...
    if (isLdapUser.value && props.agent?.is_builtin) {
        if (props.agent.id === 'builtin-wiki-researcher') {
            kbSelectionMode.value = 'all';
            formData.value.config.kb_selection_mode = 'all';
            return;
        }
        if (props.agent.id === 'builtin-smart') {
...
const initMcpSelectionMode = () => {
    // LDAP 用户：MCP 强制默认选择全部，不可编辑
    if (isLdapUser.value) {
        mcpSelectionMode.value = 'all';
        formData.value.config.mcp_selection_mode = 'all';
...
const initSkillsSelectionMode = () => {
    // LDAP 用户内置智能体强制 Skills 配置
    if (isLdapUser.value && props.agent?.is_builtin) {
        if (props.agent.id === 'builtin-wiki-researcher') {
            // wiki-researcher: Skills 选择默认禁用（none），但界面可编辑
        ...
        if (props.agent.id === 'builtin-smart') {
            // builtin-smart: Skills 选择默认为 selected（指定），但菜单不展示
            if (!formData.value.config.skills_selection_mode) {
...
watch(kbSelectionMode, (mode) => {
    ...
    if (isLdapUser.value && props.agent?.is_builtin) {
        if (props.agent.id === 'builtin-wiki-researcher') {
            if (mode !== 'all') kbSelectionMode.value = 'all';
            return;
        }
        if (props.agent.id === 'builtin-smart') {
            if (mode !== 'none') kbSelectionMode.value = 'none';
            return;
        }
    }
...
watch(
    ...
    async (visible, prevVisible) => {
        if (prevVisible && !visible && props.visible) {
            try {
                await Promise.all([chatResources.ensureModels(true), editorResources.ensureStorageEngine(true)]);
...
const applyPromptTemplateDefaults = (cfg: PromptTemplatesConfig | null) => {
    ...
    const modelFallback =
        fallbackList.find((t) => t.mode === 'model' && t.default) || fallbackList.find((t) => t.mode === 'model');
...
const genericPlaceholderFieldKeyMap: Record<
    Exclude<GenericPlaceholderType, 'intent'>,
    keyof typeof formData.value.config
> = {
...
const handlePlaceholderClick = (
    type: 'system' | 'context' | 'rewriteSystem' | 'rewriteUser' | 'fallback' | 'intent',
    placeholderName: string
) => {
    if (type === 'system') {
...
const handleSave = async () => {
    ...
    if (!isBuiltinAgent.value) {
        ...
        if (
            !isAgentMode.value &&
            (!formData.value.config.context_template || !formData.value.config.context_template.trim())
        ) {
