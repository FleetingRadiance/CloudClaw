<template>
    <div class="agent-list-container">
        <ListSpaceSidebar
            ...
            :count-favorites="agentFavoritesCount"
            ...
            <div class="header" style="--wails-draggable: drag">
                <div class="header-title" style="--wails-draggable: drag">
                    <div class="title-row" style="--wails-draggable: drag">
                        ...
                        <t-tooltip
                            v-if="authStore.hasRole('contributor') && authStore.user?.user_type !== 'ldap_user'"
                            :content="$t('agent.createAgent')"
                            placement="bottom"
                        >
                            <t-button
                                variant="text"
            ...
            <div class="agent-list-main">
             ...
             Card-level creator display + URL-state field are retained. -->
                        ...
                        <div class="card-header">
                            <div class="card-header-left">
                                <t-skeleton
                                    ...
                                    :row-col="[
                                        [
                                            { width: '32px', height: '32px', type: 'circle' },
                ...
                >
                 ...
                 builtin 排到最前；这里只在第一张 builtin 之前打一次标题。 -->
                        <div
                            ...
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('builtin')"
                        ...
                        >
                            ...
                            <t-icon
                                ...
                                :name="isAgentSectionCollapsed('builtin') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                 ...
                 要么是同事创建。与 KB 列表对齐。 -->
                        <div
                            v-if="
                                ...
                                (index === 0 ||
                                    !filteredAgents[index - 1].isMine ||
                                    (filteredAgents[index - 1] as AgentWithUI).is_builtin ||
                                    !isMyAgent(filteredAgents[index - 1] as AgentWithUI))
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('mine')"
                        ...
                        >
                            ...
                            <t-icon
                                class="agent-section-toggle"
                                :name="isAgentSectionCollapsed('mine') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                        ...
                        <div
                            ...
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('tenantOthers')"
                        ...
                        >
                            ...
                            <t-icon
                                class="agent-section-toggle"
                                :name="isAgentSectionCollapsed('tenantOthers') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                        ...
                        <div
                            v-if="
                                ...
                                (index === 0 || filteredAgents[index - 1].isMine)
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('sharedEditable')"
                        ...
                        >
                            ...
                            <t-icon
                                class="agent-section-toggle"
                                :name="isAgentSectionCollapsed('sharedEditable') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                        <!-- 共享给我 · 仅查看 -->
                        <div
                            v-if="
                                ...
                                (index === 0 ||
                                    filteredAgents[index - 1].isMine ||
                                    isSharedAgentEditable((filteredAgents[index - 1] as any).permission))
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('sharedReadonly')"
                        ...
                        >
                            ...
                            <t-icon
                                class="agent-section-toggle"
                                :name="isAgentSectionCollapsed('sharedReadonly') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                        <div
                   ...
                   "更多"按钮腾出空间，避免重叠。 -->
                            ...
                            <div class="card-header">
                                <div class="card-header-left">
                                    ...
                                    <div v-else-if="agent.avatar" class="builtin-avatar agent-emoji">
                                        {{ agent.avatar }}
                                    </div>
                                ...
                                >
                                    ...
                                    <template #content>
                                        <div class="popup-menu">
                                            ...
                                            >
                                                <t-icon class="menu-icon" name="edit" /><span>{{
                                                    $t('common.edit')
                                                }}</span>
                                            </div>
                                            <div
                                                v-if="authStore.hasRole('contributor') && !isLdapUser"
                                                class="popup-menu-item"
                                                @click="handleCopy(agent)"
                                            >
                                                <t-icon class="menu-icon" name="file-copy" /><span>{{
                                                    $t('common.copy')
                                                }}</span>
                                            </div>
                                            <div
                                                v-if="authStore.hasRole('admin') && !(isLdapUser && agent.is_builtin)"
                                                class="popup-menu-item"
                                                @click="handleToggleDisabled(agent)"
                                            >
                                                <t-icon class="menu-icon" name="poweroff" />
                                                <span>{{
                                                    agent.disabled_by_me ? $t('agent.enable') : $t('agent.disable')
                                                }}</span>
                                            </div>
                                            <div
                                                v-if="!agent.is_builtin && canManageAgent(agent)"
                                                class="popup-menu-item delete"
                                                @click="handleDelete(agent)"
                                            >
                                                <t-icon class="menu-icon" name="delete" /><span>{{
                                                    $t('common.delete')
                                                }}</span>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div
                                        class="more-wrap"
                                        :class="{ 'active-more': openMoreAgentId === 'shared-' + agent.share_id }"
                            ...
                            <div class="card-bottom">
                                <div class="bottom-left">
                                    <div class="feature-badges">
                                        <t-tag
                                            v-if="agent.isMine && agent.disabled_by_me"
                                            theme="default"
                                            size="small"
                                        ...
                                        >
                                            <div
                                                class="feature-badge"
                                                :class="{
                                                    'mode-normal': agent.config?.agent_mode === 'quick-answer',
                                                    'mode-agent': agent.config?.agent_mode === 'smart-reasoning'
                                                }"
                                            >
                                                <t-icon
                                                    :name="
                                        ...
                                        <t-tooltip
                                            v-if="agent.config?.web_search_enabled"
                                            :content="$t('agent.features.webSearch')"
                                            placement="top"
                                        >
                                        ...
                                        <t-tooltip
                                            v-if="
                                                agent.config?.knowledge_bases?.length ||
                                                agent.config?.kb_selection_mode === 'all'
                                            "
                                            :content="$t('agent.features.knowledgeBase')"
                                            placement="top"
                                        >
                                        ...
                                        <t-tooltip
                                            v-if="
                                                agent.config?.mcp_services?.length ||
                                                agent.config?.mcp_selection_mode === 'all'
                                            "
                                            :content="$t('agent.features.mcp')"
                                            placement="top"
                                        >
                                        ...
                                        <t-tooltip
                                            v-if="agent.config?.multi_turn_enabled"
                                            :content="$t('agent.features.multiTurn')"
                                            placement="top"
                                        >
                    ...
                    <template v-for="(agent, index) in sortedMineAgents" :key="agent.id">
                        ...
                        <div
                            v-if="
                                showShareGroupHeaders &&
                                agent.is_builtin &&
                                (index === 0 || !sortedMineAgents[index - 1].is_builtin)
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                        ...
                        <div
                            v-if="
                                ...
                                (index === 0 ||
                                    ...
                                    !isMyAgent(sortedMineAgents[index - 1]))
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                ...
                <div v-else-if="spaceSelectionOrgId && sortedSpaceAgentsList.length > 0" class="agent-card-wrap">
                    <template v-for="(shared, index) in sortedSpaceAgentsList" :key="'shared-' + shared.share_id">
                        ...
                        <div
                            ...
                            role="button"
                            tabindex="0"
                            @click="toggleAgentSection('sharedByMe')"
                        ...
                        >
                            ...
                            <t-icon
                                class="agent-section-toggle"
                                :name="isAgentSectionCollapsed('sharedByMe') ? 'chevron-right' : 'chevron-down'"
                                size="14px"
                            />
                        </div>
                        ...
                        <div
                            v-if="
                                ...
                                (index === 0 || sortedSpaceAgentsList[index - 1].is_mine)
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                        ...
                        <div
                            v-if="
                                ...
                                (index === 0 ||
                                    ...
                                    isSharedAgentEditable(sortedSpaceAgentsList[index - 1].permission))
                            "
                            class="agent-section-header"
                            role="button"
                            tabindex="0"
                        ...
                        <div
                            v-show="!isSpaceAgentCollapsed(shared)"
                        ...
                        >
                            ...
                            <div class="card-header">
                                <div class="card-header-left">
                                    <div v-if="shared.agent?.avatar" class="builtin-avatar agent-emoji">
                                        {{ shared.agent.avatar }}
                                    </div>
                                ...
                                >
                                    <div
                                        class="more-wrap"
                                        :class="{ 'active-more': openMoreAgentId === 'shared-tab-' + shared.share_id }"
                                    ...
                                    <template #content>
                                        <div class="popup-menu">
                                            <div
                                                class="popup-menu-item"
                                                @click="handleToggleSharedDisabledFromShared(shared)"
                                            >
                                                <t-icon class="menu-icon" name="poweroff" />
                                                <span>{{
                                                    shared.disabled_by_me ? $t('agent.enable') : $t('agent.disable')
                                                }}</span>
                                            </div>
                                        </div>
                                    </template>
                            ...
                            <div class="card-content">
                                <div class="card-description">
                                    {{ shared.agent?.description || $t('agent.noDescription') }}
                                </div>
                            </div>
                            <div class="card-bottom">
                                <div class="bottom-left">
                                    <div class="feature-badges">
                                        ...
                                        <t-tooltip
                                            :content="
                                                shared.agent?.config?.agent_mode === 'smart-reasoning'
                                                    ? $t('agent.mode.agent')
                                                    : $t('agent.mode.normal')
                                            "
                                            placement="top"
                                        >
                                            <div
                                                class="feature-badge"
                                                :class="{
                                                    'mode-normal': shared.agent?.config?.agent_mode === 'quick-answer',
                                                    'mode-agent': shared.agent?.config?.agent_mode === 'smart-reasoning'
                                                }"
                                            >
                                                <t-icon
                                                    :name="
                                        ...
                                        <t-tooltip
                                            v-if="shared.agent?.config?.web_search_enabled"
                                            :content="$t('agent.features.webSearch')"
                                            placement="top"
                                        >
                                            <div class="feature-badge web-search">
                                        ...
                                        <t-tooltip
                                            v-if="
                                                shared.agent?.config?.knowledge_bases?.length ||
                                                shared.agent?.config?.kb_selection_mode === 'all'
                                            "
                                            :content="$t('agent.features.knowledgeBase')"
                                            placement="top"
                                        >
                                        ...
                                        <t-tooltip
                                            v-if="
                                                shared.agent?.config?.mcp_services?.length ||
                                                shared.agent?.config?.mcp_selection_mode === 'all'
                                            "
                                            :content="$t('agent.features.mcp')"
                                            placement="top"
                                        >
                                        ...
                                        <t-tooltip
                                            v-if="shared.agent?.config?.multi_turn_enabled"
                                            :content="$t('agent.features.multiTurn')"
                                            placement="top"
                                        >
                                            <div class="feature-badge multi-turn">
                ...
                <div v-if="spaceSelection === 'all' && filteredAgents.length === 0 && !loading" class="empty-state">
                    ...
                    <t-button
                        v-if="authStore.hasRole('contributor') && authStore.user?.user_type !== 'ldap_user'"
                        class="agent-create-btn empty-state-btn"
                        data-guide="agent-list-create"
                        @click="handleCreateAgent"
                    >
                        <template #icon>
                ...
                <!-- 空状态：空间下 -->
                <div
                    v-if="spaceSelectionOrgId && !spaceAgentsLoading && spaceAgentsList.length === 0"
                    class="empty-state"
                >
                    <img class="empty-img" src="@/assets/img/upload.svg" alt="" />
        ...
        <Transition name="shared-detail-drawer">
            <div
                v-if="sharedDetailVisible && currentSharedAgent"
                        ...
                        <template v-if="currentSharedAgent.agent?.config">
                            ...
                            <div class="shared-detail-row">
                                ...
                                <span class="shared-detail-value">{{
                                    currentSharedAgent.agent.config.model_id
                                        ? $t('agent.shareScope.modelConfigured')
                                        : $t('agent.shareScope.modelNotSet')
                                }}</span>
                            </div>
                            <div v-if="sharedAgentUsesKb" class="shared-detail-row">
                                <span class="shared-detail-label">{{ $t('agent.shareScope.rerankModel') }}</span>
                                <span class="shared-detail-value">{{
                                    currentSharedAgent.agent.config.rerank_model_id
                                        ? $t('agent.shareScope.modelConfigured')
                                        : $t('agent.shareScope.modelNotSet')
                                }}</span>
                            </div>
                            <div class="shared-detail-row">
                                ...
                                <span class="shared-detail-value">{{
                                    currentSharedAgent.agent.config.web_search_enabled
                                        ? $t('agent.shareScope.enabled')
                                        : $t('agent.shareScope.disabled')
                                }}</span>
                            </div>
                            <div class="shared-detail-row">
...
const agentFavoritesCount = computed(() => pins.favorites.value.filter((e) => e.type === 'agent').length);
const agentRecentsCount = computed(() => pins.recents.value.filter((e) => e.type === 'agent').length);
...
const filteredAgents = computed<DisplayAgent[]>(() => {
    ...
    agents.value.forEach((a) => {
        if (a.is_builtin) {
            // LDAP 用户显示 builtin-smart 和 builtin-wiki-researcher
            const ldapAllowed = new Set(['builtin-smart', 'builtin-wiki-researcher']);
            if (isLdapUser.value && !ldapAllowed.has(a.id)) return;
            builtin.push(a);
...
const sharedAgentKbScopeText = computed(() => {
    ...
    if (c.kb_selection_mode === 'selected' && c.knowledge_bases?.length)
        return t('agent.shareScope.kbSelected', { count: c.knowledge_bases.length });
...
watch(
    ...
    (val) => {
        ...
        listOrganizationSharedAgents(val)
            .then((res) => {
...
const handleCardClick = (agent: DisplayAgent | AgentWithUI) => {
    ...
    if ('isMine' in agent && !agent.isMine) {
        const shared = sharedAgents.value.find(
            (s) => s.agent?.id === agent.id && s.source_tenant_id === agent.source_tenant_id
        );
...
function canManageAgent(agent: AgentWithUI): boolean {
    // LDAP normal users can manage allowed built-in agents
    if (authStore.user?.user_type === 'ldap_user') {
        const ldapAllowed = new Set(['builtin-wiki-researcher', 'builtin-smart']);
        return !!(agent.is_builtin && ldapAllowed.has(agent.id));
    }
...
const tenantSectionLabelKey = computed(() =>
    authStore.hasRole('admin') ? 'agent.sections.tenantOthers' : 'agent.sections.tenantReadonly'
);
...
const spaceAgentSectionCounts = computed<Record<AgentSectionKey, number>>(() => {
    const c = emptyAgentCounts();
    sortedSpaceAgentsList.value.forEach((shared) => {
        c[spaceAgentSectionOf(shared)]++;
    });
    return c;
});
...
const handleToggleDisabled = (agent: AgentWithUI) => {
    ...
    setSharedAgentDisabledByMe(agent.id, nextDisabled)
        .then((res: any) => {
            if (res.success) {
...
const handleToggleSharedDisabledFromShared = (shared: SharedAgentInfo) => {
    ...
    setSharedAgentDisabledByMe(shared.agent.id, nextDisabled)
        .then((res: any) => {
            if (res.success) {
                MessagePlugin.success(nextDisabled ? t('agent.messages.disabled') : t('agent.messages.enabled'));
                orgStore.fetchSharedAgents({ force: true });
