...
const troubleshootingDocsURL =
  'https://github.com/Tencent/CloudClow/blob/main/docs/migration-troubleshooting.md'
...
const reportIssueURL = computed(() => {
  const base = 'https://github.com/Tencent/CloudClow/issues/new'
  ...
  if (errMsg) {
    const body = [
      '### Environment',
      `- CloudClow version: ${systemInfo.value?.version || 'unknown'}`,
