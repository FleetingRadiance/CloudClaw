            ...
            <div v-if="canShare" class="share-form">
                <div class="form-item">
                    ...
                    <div class="share-input-row">
                                        ...
                                        <div class="org-option-meta">
                                            ...
                                            <span class="org-meta-tag">
                                                <img
                                                    ...
                                                    class="org-meta-icon org-meta-icon-agent"
                                                    alt=""
                                                    aria-hidden="true"
                                                />
                        ...
                        <t-select v-model="selectedPermission" class="permission-select">
                            ...
                            <div class="share-info-top">
                                <div class="share-org">
                                    <SpaceAvatar
                                        ...
                                        :avatar="
                                            orgStore.organizations.find((o) => o.id === share.organization_id)?.avatar
                                        "
                                        size="small"
                                    />
...
// Only show organizations where user can share; exclude already shared.
// For LDAP users (viewer role in the admin's org), they can also share
// their own KB to the org even though they are viewers — the backend
// OwnedKBOrAdmin guard checks KB ownership, not org role.
const availableOrganizations = computed(() => {
    ...
    return orgStore.organizations.filter(
        (org) =>
            ...
            (org.is_owner === true || org.my_role === 'admin' || org.my_role === 'editor' || org.my_role === 'viewer')
    );
});
