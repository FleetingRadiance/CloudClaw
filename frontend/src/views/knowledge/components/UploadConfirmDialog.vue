                    ...
                    <div class="upload-confirm-container">
                        <aside class="files-panel">
                            ...
                            <div v-if="mode === 'manual' && manualPreview" class="manual-source-panel">
                                <p class="manual-source-title" :title="manualPreview.title">
                                    {{ manualPreview.title }}
                                </p>
                        ...
                        <main class="main-panel">
                            <header class="main-header">
                                ...
                                <template v-else>
                                    <button type="button" class="back-link" @click="activeSection = 'overview'">
                            ...
                            <div class="main-body">
                                ...
                                <div v-else class="edit-section edit-section--embedded">
                                    ...
                                    <div v-show="activeSection === 'multimodal'" class="section">
                                        <div class="kb-embedded-settings">
                                            ...
                                            <div
                                                ...
                                                class="setting-row setting-row--field"
                                            >
                                                <div class="setting-info">
                                                    <label>
                                    ...
                                    <div v-if="!isLdapUser" v-show="activeSection === 'asr'" class="section">
                                        <div class="kb-embedded-settings">
                                            <div class="setting-row setting-row--toggle">
                                                <div class="setting-info">
...
const chunkingOverviewValue = computed(() => {
    ...
    parts.push(
        c.enableParentChild ? t('uploadConfirm.summaryParentChildShort') : t('uploadConfirm.summaryParentChildOff')
    );
    return parts.join(' · ');
});
    ...
    const lines = [
        ...
        { key: 'chunking', title: t('uploadConfirm.tabChunking'), value: chunkingOverviewValue.value },
        {
            ...
            value: mm.enabled
                ...
                : hasImages.value
                  ? t('uploadConfirm.multimodalRequiredForImages')
                  : t('uploadConfirm.statusOff')
        }
    ];

    // LDAP 用户不显示音频处理（ASR）条目
    if (!isLdapUser.value) {
        lines.push({
            key: 'asr',
            ...
            value: asr.enabled
                ...
                : hasAudio.value
                  ? t('uploadConfirm.asrRequiredForAudio')
                  : t('uploadConfirm.statusOff')
        });
    }
...
const sectionMeta: Record<string, { titleKey: string; descKey?: string }> = {
    ...
    question: {
        titleKey: 'uploadConfirm.tabQuestion',
        descKey: 'knowledgeEditor.advanced.questionGeneration.description'
    },
...
function applyOverridesToState(o?: KnowledgeProcessOverrides | null) {
    ...
    if (ec) {
        ...
        if (ec.nodes)
            s.nodeExtractConfig.nodes = ec.nodes.map((n) => ({ name: n.name, attributes: n.attributes || [] }));
