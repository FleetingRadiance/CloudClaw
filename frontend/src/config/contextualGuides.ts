...
export const GLOBAL_USER_GUIDE_KEY = 'cloudclow:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'cloudclow:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'cloudclow:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'cloudclow:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'cloudclow:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'cloudclow:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'cloudclow:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'cloudclow:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'cloudclow:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'cloudclow:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'cloudclow:contextual-guide-agent-create:v1',
