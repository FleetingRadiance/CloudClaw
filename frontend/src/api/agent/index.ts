...
// 'custom'       : 完全自定义（不应用预设）
export type AgentType = 'rag-qa' | 'wiki-qa' | 'hybrid-rag-wiki' | 'custom';
...
export const BUILTIN_SMART_ID = 'builtin-smart';
...
// Deprecated: ReAct mode entry is now builtin-smart for all users
export const BUILTIN_AGENT_AGENT_ID = BUILTIN_SMART_ID;
